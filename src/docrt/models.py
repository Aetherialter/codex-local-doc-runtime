...
class ErrorCode(StrEnum):
    ...
    OFFICE_COM_REQUIRED = "OFFICE_COM_REQUIRED"
...
ERROR_EXIT_MAP: dict[str, ExitCode] = {
    ...
    ErrorCode.CORRUPT_DOCUMENT.value: ExitCode.UNSUPPORTED_FORMAT,
    ...
    ErrorCode.UV_UNAVAILABLE.value: ExitCode.DEPENDENCY_MISSING,
    ErrorCode.UV_BOOTSTRAP_FAILED.value: ExitCode.DEPENDENCY_MISSING,
    ErrorCode.OFFICE_COM_REQUIRED.value: ExitCode.OFFICE_UNAVAILABLE,
